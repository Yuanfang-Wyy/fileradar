...
module.exports = {
  ...
  mac: {
    ...
    extendInfo: {
      ...
      NSDesktopFolderUsageDescription: 'FileRadar 需要访问桌面以建立文件索引。',
      NSDocumentsFolderUsageDescription: 'FileRadar 需要访问文稿以建立文件索引。',
      NSDownloadsFolderUsageDescription: 'FileRadar 需要访问下载以建立文件索引。',
    },
  },
  dmg: {
    title: 'FileRadar ${version}',
    contents: [
